        ...
        <div className="centralizar">
            <Card className='card-main' style={{width: '70%'}}>
                <Row gutter={32}>
                    ...
                    <Col sm={24}>
                        <p style={styleCentralizado}>Veja os detalhes que o Onsurance preparou para o seu pneu aro {veiculo.aro}.</p>
                    </Col>
                    <Col sm={12} md={6}>
                    ...
                    <Col sm={24}>
                        <p style={styleCentralizado}>
                            O Onsurance do pneu do seu {veiculo.tipo_de_veiculo} aro {veiculo.aro} da marca {veiculo.marca},
                            de valor R${veiculo.total} custa R${results.minuteValue} por minuto! <br/>
                            Considerando seu uso diário de {onsurance.horas_por_dia} horas o crédito inicial durará {results.creditDuration} meses.
                        </p>
                    </Col>
                    <Col sm={24}>
                        <p style={styleCentralizado}>
                            Quando acabar, é só fazer uma recarga mínima de R$ 299.
                        </p>
                    </Col>
                    <Col sm={24}>
                        <a className='link-externo' href='https://onsurance.me/produto/' target='blanck'>Contratar Agora!</a>
                    </Col>
                    <Col sm={24}>
                        <p style={styleCentralizado}>
